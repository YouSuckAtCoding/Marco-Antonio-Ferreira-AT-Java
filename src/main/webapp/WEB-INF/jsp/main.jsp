...
<nav class="navbar navbar-expand-lg bg-body-tertiary">  
  <div class="container-fluid">
    <a class="navbar-brand" href="/index">At_Java</a>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="#">Cordas</a></li>
            <li><a class="dropdown-item" href="#">Sopro</a></li>
            <li><a class="dropdown-item" href="#">Percussão</a></li>
          </ul>
        </li>
      </ul>
      <ul class="nav navbar-nav navbar-right">
	    <c:if test="${empty selected}">
	      <li><a href="/usuario/cadastrar" class="me-4 btn btn-outline-primary">Cadastrar</a></li>
