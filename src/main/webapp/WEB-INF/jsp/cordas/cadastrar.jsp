...
<form action="/inserirCordas" method="post">
	...
	<div class="mb-3">
	 	 <label for="NumeroCordasInput" class="form-label">Número de Cordas</label>
	 	 <input type="text" class="form-control" id="NumeroCordasInput" name="NumCordas"></input>
	</div>
	<div class="mb-3">
