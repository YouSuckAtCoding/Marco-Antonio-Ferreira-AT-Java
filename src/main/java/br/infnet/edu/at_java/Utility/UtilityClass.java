...
public class UtilityClass {
    ...
    public List<Instrumento> CreateExampleProductsList(){
        ...
        try{
            Corda prod1 = new Corda("Strinberg Clg 45", "Guitarra", 900, 6);
            Sopro prod2 = new Sopro("Flauta Doce", "Flauta", 600, "Madeira", "Tenor");
            Percurssao prod3 = new Percurssao("TAMA ImperialStar", "Bateria", 8000, false, "Idiofone");
            List<Instrumento> exampList = new ArrayList<Instrumento>();
            exampList.add(prod1);
            exampList.add(prod2);
            exampList.add(prod3);
            return exampList;
